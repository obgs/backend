...
func (*PlayerSupervisionRequest) scanValues(columns []string) ([]interface{}, error) {
...
func (psr *PlayerSupervisionRequest) assignValues(columns []string, values []interface{}) error {
