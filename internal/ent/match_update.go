...
func (mu *MatchUpdate) AddPlayerIDs(ids ...guidgql.GUID) *MatchUpdate {
...
func (mu *MatchUpdate) RemovePlayerIDs(ids ...guidgql.GUID) *MatchUpdate {
...
// AddPlayerIDs adds the "players" edge to the Player entity by IDs.
func (muo *MatchUpdateOne) AddPlayerIDs(ids ...guidgql.GUID) *MatchUpdateOne {
...
// RemovePlayerIDs removes the "players" edge to Player entities by IDs.
func (muo *MatchUpdateOne) RemovePlayerIDs(ids ...guidgql.GUID) *MatchUpdateOne {
