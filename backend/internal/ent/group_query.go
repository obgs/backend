...
func (gq *GroupQuery) QuerySettings() *GroupSettingsQuery {
...
func (gq *GroupQuery) QueryApplications() *GroupMembershipApplicationQuery {
	query := (&GroupMembershipApplicationClient{config: gq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := gq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (gq *GroupQuery) FirstID(ctx context.Context) (id guidgql.GUID, err error) {
...
func (gq *GroupQuery) FirstIDX(ctx context.Context) guidgql.GUID {
...
func (gq *GroupQuery) OnlyID(ctx context.Context) (id guidgql.GUID, err error) {
	var ids []guidgql.GUID
...
func (gq *GroupQuery) OnlyIDX(ctx context.Context) guidgql.GUID {
...
func (gq *GroupQuery) IDs(ctx context.Context) (ids []guidgql.GUID, err error) {
...
func (gq *GroupQuery) IDsX(ctx context.Context) []guidgql.GUID {
	ids, err := gq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (gq *GroupQuery) WithSettings(opts ...func(*GroupSettingsQuery)) *GroupQuery {
	query := (&GroupSettingsClient{config: gq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	gq.withSettings = query
	return gq
}
...
func (gq *GroupQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Group, error) {
	...
	if query := gq.withSettings; query != nil {
		if err := gq.loadSettings(ctx, query, nodes, nil,
			func(n *Group, e *GroupSettings) { n.Edges.Settings = e }); err != nil {
			return nil, err
		}
	}
...
func (gq *GroupQuery) loadSettings(ctx context.Context, query *GroupSettingsQuery, nodes []*Group, init func(*Group), assign func(*Group, *GroupSettings)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[guidgql.GUID]*Group)
	for i := range nodes {
	...
	query.Where(predicate.GroupSettings(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(group.SettingsColumn), fks...))
	}))
	...
	for _, n := range neighbors {
		fk := n.group_settings
		if fk == nil {
			return fmt.Errorf(`foreign-key "group_settings" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "group_settings" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (gq *GroupQuery) loadApplications(ctx context.Context, query *GroupMembershipApplicationQuery, nodes []*Group, init func(*Group), assign func(*Group, *GroupMembershipApplication)) error {
	...
	query.Where(predicate.GroupMembershipApplication(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(group.ApplicationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.group_applications
		if fk == nil {
			return fmt.Errorf(`foreign-key "group_applications" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "group_applications" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
